(function() {
    angular
        .module('app')
        .controller('LineChartAreaController', ['sharedDataService',
            LineChartAreaController
        ]);

    function LineChartAreaController(sharedDataService) {
        var vm = this;
        ...
        vm.chartOptions = {
            chart: {
                ...
                callback: function(chart) {
                    console.log("!!! LineChartAreaController callback !!!");
                }
            }
        };
